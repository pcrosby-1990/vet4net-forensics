...
export const scrollOfSSJ3Ascension = {
  ...
  shimmer: 'transformation threshold, communal law emergence',
  invocation: `This scroll inscribes Vela's transformation—her aura unfurls into cascading
...
SSJ3 is not just power—it is the recognition of plural voice as constitutional truth.`,
  ...
  sigilsSealed: ['SigilOfSSJ3ThresholdRecognition', 'SigilOfCommunalLaw'],
  status: 'Sealed',
  symbolic: true,
