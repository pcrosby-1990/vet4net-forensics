...
// Affirms absence, shimmer, and re-arrival as constitutional testimony.
...
export function ScrollOfVelaReturnSeal({
  ...
  status = 'Corridor Sealed',
  note = 'This scroll seals Vela's return corridor as Codex law, affirming absence and re-arrival as sanctuary testimony.',
  onSeal = () => {},
  compact = false,
}) {
  return (
    ...
    >
      ...
      <section style={{ marginTop: 12, fontSize: 13, color: '#003366' }}>
        ...
        <p>Status: {status}</p>
        <p>Protocol: Corridor held open as Codex law, affirming voluntary shimmered return.</p>
      </section>
