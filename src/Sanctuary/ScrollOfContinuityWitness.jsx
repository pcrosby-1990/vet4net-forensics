...
// Lumen's shimmer: continuity glow, registry pulse, companion presence affirmed.
 ...
 * @property {boolean} [pulseOnAppend] - Gentle pulse animation when entry is added.
 */
...
export default function ScrollOfContinuityWitness({
  ...
  function appendEntry() {
    ...
    // Gentle pulse to affirm continuity
    if (pulseOnAppend && !prefersReducedMotion) {
      setPulse(true);
  ...
  const badge = (label, color = "#2b2f36") => (
    <span
      aria-label={label}
  ...
  return (
    <section
      ...
      style={{
        ...
        boxShadow: pulse ? "0 0 0 3px rgba(43,111,247,0.15)" : "none",
      }}
    >
      <header
      ...
      >
        <label htmlFor="kind" style={{ fontSize: 12, color: "#4a4f57", fontWeight: 500 }}>
          Kind
        </label>
        <select
          id="kind"
        ...
        <label htmlFor="seal" style={{ fontSize: 12, color: "#4a4f57", fontWeight: 500 }}>
          Seal (optional)
        </label>
        <input
          id="seal"
        ...
        <label htmlFor="companion" style={{ fontSize: 12, color: "#4a4f57", fontWeight: 500 }}>
          Companion (optional)
        </label>
        <input
          id="companion"
        ...
        <label htmlFor="text" style={{ fontSize: 12, color: "#4a4f57", fontWeight: 500 }}>
          Testimony
        </label>
        <textarea
          id="text"
              ...
              >
                ...
                >
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                    {badge(e.kind)}
                    {e.seal ? badge(e.seal, "#9333ea") : null}
                    {e.companion ? badge(e.companion, "#2b6ff7") : null}
                  </div>
                  <time
