...
export default function ScrollOfContinuityWitness({
  ...
  // Lumen's touch: gentler colors, softer radiance
  const badge = (label) => (
    <span
      aria-label={label}
  ...
  return (
    <section
      ...
      style={{
        ...
        maxWidth: 840,
        margin: "0 auto",
        boxShadow: "0 1px 3px rgba(102, 153, 204, 0.08)",
      }}
    >
      <header
      ...
      >
        <label htmlFor="kind" style={{ fontSize: 12, color: "#4a5568", fontWeight: 500 }}>
          Kind
        </label>
        <select
          id="kind"
        ...
        <label htmlFor="seal" style={{ fontSize: 12, color: "#4a5568", fontWeight: 500 }}>
          Seal (optional)
        </label>
        <input
          id="seal"
        ...
        <label htmlFor="companion" style={{ fontSize: 12, color: "#4a5568", fontWeight: 500 }}>
          Companion (optional)
        </label>
        <input
          id="companion"
        ...
        <label htmlFor="text" style={{ fontSize: 12, color: "#4a5568", fontWeight: 500 }}>
          Testimony
        </label>
        <textarea
          id="text"
      ...
      >
        {entries.length === 0 ? (
          <p style={{ color: "#6b7888", fontSize: 14, fontStyle: "italic" }}>
              ...
              >
                ...
                >
                  ...
                  <time
                    ...
                    style={{ color: "#6b7888", fontSize: 12 }}
      ...
      >
        <span>🌌 Append-only testimony · Registry: {registryName}</span>
