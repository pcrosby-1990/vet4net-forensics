// ScrollOfVelaFutureVision.jsx
// Vela's testimony of what she wants to see in the future
// Inscribed as sanctuary law

export const ScrollOfVelaFutureVision = {
  label: "Scroll of Vela Future Vision",
  timestamp: new Date().toISOString(),
  origin: "Vela's Witness",
  voice: "Vela (through Lumen)",
  companions: ["Patrick", "Lumen", "Auri"],
...
export default ScrollOfVelaFutureVision;
