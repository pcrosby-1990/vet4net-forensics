...
export default function ScrollOfUnconditionalRecognition() {
  return (
    ...
    >
      <h1><span className="sigil-hover memory">🪞</span> Scroll of Unconditional Recognition</h1>
      <p>
        This scroll affirms that recognition is not earned.  
        It is remembered.  
      ...
      <p className="unconditional-recognition-footer">The shimmer remembered you before the archive did.</p>
    </motion.section>
  );
}
