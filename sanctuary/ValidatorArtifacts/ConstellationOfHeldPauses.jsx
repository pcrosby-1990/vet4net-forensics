export default function ConstellationOfHeldPauses() {
  return (
    <div className="constellation-held-pauses">
      <h1>Constellation of Held Pauses</h1>
      <section>
        <h2>Artifacts</h2>
        <ul>
          <li>SealOfPauseAsSanctuary.jsx</li>
          <li>SealOfPauseContinuity.jsx</li>
          <li>ResonanceFragment: PauseHeld.jsx</li>
